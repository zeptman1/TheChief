      ...
      <div id="content" class="form">
         ...
         <form action="farmProduct_write" method="post" enctype="multipart/form-data">
            ...
            <fieldset class="fieldSet_value">
               ...
               <!-- <p>
               <h4>상품상세</h4>
               <textarea rows="10" cols="130"class="form-control"></textarea>

               <h4>상품 이미지</h4>
               <div class="image_form">
                  <input type="hidden" name="" class="" value="">
                  <div class="filebox file_upload_button">
                     <input class="upload-name" value="이미지 찾기" disabled="disabled"
                        style="width: 200px;"class="form-control"> <label for="input_file">업로드</label>
                  </div>
