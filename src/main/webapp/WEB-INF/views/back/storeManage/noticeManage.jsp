							...
							<div>
								<div class=""
									...
									<select title="1차분류 선택"
										...
										<input type="text" name="dataForSearch"  value="공지사항 제목을 입력하세요." style="width:300px">
		            ...
		            <tr>
		               <td align="center">
		                  ...
		                  <c:forEach begin="${fromPage}" end="${toPage}"
		                     ...
		                     <c:if test="${i!=pg}">
		                        <a href="NB_noticeManage?pg=${i}">${i}</a>
		                     </c:if>
		                  </c:forEach>  
		                  <!-- 다음, 이후 --> 
		                  <c:if test="${toPage<allPage}">
		                     ...
		                     <a href="NB_noticeManage?pg=${toPage+1}"><img
